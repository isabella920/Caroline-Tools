...
<div class="relative w-full">
    ...
    <div id="select-options" class="hidden absolute top-full left-0 w-full mt-2 glass-panel rounded-2xl overflow-hidden z-[10000] border border-white/20 shadow-2xl animate-in slide-in-from-top-2 duration-200">
